...
class _HomeApiService implements HomeApiService {
  ...
  @override
  Future<List<GetAboutPrivacyResponse>> getAboutPrivacy() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<GetAboutPrivacyResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<GetAboutPrivacyResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              GetAboutPrivacyResponse.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
