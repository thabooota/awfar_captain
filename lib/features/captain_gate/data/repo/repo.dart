...
import '../model/requests/get_report_request_body.dart';
...
class CaptainGateRepo {
  ...
  Future<ApiResult<GetReportResponse>> getReport({required GetReportRequestBody getReportRequestBody, required String token}) async {
    try {
      final response = await _captainApiServices.getReport(
          token: 'Bearer $token',
