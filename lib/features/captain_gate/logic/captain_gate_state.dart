...
class GetReportLoading extends CaptainGateStates {}

class GetReportSuccess extends CaptainGateStates {
  final GetReportResponse myReport;
  GetReportSuccess({required this.myReport});
}

class GetReportError extends CaptainGateStates {
  final String error;
  GetReportError({required this.error});
}