        ...
        children: [
          Row(
            children: [
              ...
              horizontalSpace(3.w),
              Expanded(child: Text( cubit.tripAcceptedResponse!.Client.name, style: TextStyleManager.font17TextColor600.copyWith(overflow: TextOverflow.fade),)),
          ...
          const Divider(),
          Text(
              LocaleKeys.meetingLocation.tr(), style: TextStyleManager.font13Black600
          ),
          Text(cubit.tripAcceptedResponse!.From, style: TextStyleManager.font17TextColor400),
          verticalSpace(10.h),
          const Divider(),
          Text(LocaleKeys.arrivalLocation.tr(), style: TextStyleManager.font13Black600),
          Text(cubit.tripAcceptedResponse!.To, style: TextStyleManager.font17TextColor400,),
          verticalSpace(10.h),
          const Divider(),
          ...
          Row(
            ...
            children: [
              Image.asset(AssetsManager.icCall, width: 50.w,),
              Image.asset(AssetsManager.icChat, width: 50.w,),
            ],),
          verticalSpace(30.h),
